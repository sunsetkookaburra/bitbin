...
export class Base64EncoderStream extends PipelineStream<[TransformStream<Uint8Array, Uint8Array>, TransformStream<Uint8Array, Uint8Array>]> {
  constructor() {
    super(
      new ChunksStream(3),
      new MapStream(chunk => {
...
export class Base64DecoderStream extends PipelineStream<[TransformStream<Uint8Array, Uint8Array>, TransformStream<Uint8Array, Uint8Array>]> {
  constructor() {
    super(
      new ChunksStream(4),
      new MapStream(chunk => {
